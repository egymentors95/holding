...
class Home(http.Controller):
    ...
    def web_login(self, redirect=None, **kw):
        ...
        if style == 'default' or style is False:
            ...
            response = request.render('odex25_debrand.left_login_template', values)
        elif style == 'right':
            response = request.render('odex25_debrand.right_login_template', values)
        else:
            response = request.render('odex25_debrand.middle_login_template', values)
