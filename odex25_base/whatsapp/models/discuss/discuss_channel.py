...
from ...tools.avatar_mixin import get_hsl_from_seed
...
class Channel(models.Model):
    ...
    def _compute_member_count(self):
        ...
        for item in read_group_res:
            ...
            value = item['channel_id_count']
            member_count_by_channel_id[key] = value
    ...
    def create(self, vals_list):
        ...
        return channels
    # todo change to unlink() overwrite
    ...
    def _notify_get_recipients(self, message, msg_vals, **kwargs):
        ...
        if pids:
            ...
            self.env['res.partner'].flush(['active', 'email', 'partner_share'])
            self.env['res.users'].flush(['notification_type', 'partner_id'])
            sql_query = """
    ...
    def _channel_info(self):
        ...
        current_partner, current_guest = self.env["res.partner"]._get_current_persona()
        self.env['discuss.channel'].flush()
        self.env['discuss.channel.member'].flush()
    ...
    def create_group(self, partners_to, default_display_mode=False, name=''):
        ...
        channel = (0, 0, {
            'channel_member_ids': [(0 ,0 ,{'partner_id': partner_id}) for partner_id in partners_to],
            'channel_type': 'group',
