...
try:
    ...
    # todo from odoo.tools._vendor.send_file
...
from odoo.tools import (config, consteq, date_utils, parse_version,
                    profiler, unique, ustr,)
from .misc import file_path, submap, filter_kwargs
